            ...
            <div class="widget-content widget-content-area br-6">
                ...
                <div style="margin-top: 30px; margin-bottom: -25px;">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            <a href="{{ route('validasiall') }}">
                                <button style="margin-top: 32px; float: right;" class="btn btn-success validasiall" id="validasiall" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="form-group col-md-2">
                            <a href="{{ route('batalvalidasi') }}">
                                <button style="margin-top: 32px;" class="btn btn-danger invalidate" id="invalidate" type="submit">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
