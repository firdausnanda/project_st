...
<script>
    ...
    $(document).ready(function () {    
        var table = $('#rekap-dosen').DataTable({
            "oLanguage": {
                "oPaginate": {
            ...
            "rowGroup": {
                    ...
                    endRender: function (rows, group) {
                        ...
                        return $('<tr/>')
                            .append('<td colspan="3">Total ' + group + '</td>')
    ...
    //datatable penelitian
    $(document).ready(function () {    
        var table = $('#zero-penelitian').DataTable({
            "oLanguage": {
                "oPaginate": {
                    "sPrevious": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>',
                    "sNext": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>'
    ...
    //datatable pengabdian
    $(document).ready(function () {    
        var table = $('#zero-pengabdian').DataTable({
            "oLanguage": {
                "oPaginate": {
                    "sPrevious": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>',
                    "sNext": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>'
    ...
    //datatable jabatan
    $(document).ready(function () {    
        var table = $('#zero-jabatan').DataTable({
            "oLanguage": {
                "oPaginate": {
                    "sPrevious": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left"><line x1="19" y1="12" x2="5" y2="12"></line><polyline points="12 19 5 12 12 5"></polyline></svg>',
                    "sNext": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>'
    ...
    //autofill nama detail_jabatan
    $(document).ready(function () {
        $(document).on('change', '#nama_jabatan', function () {
            var id = $(this).val();
            var url = '{{ route("getDetailNamaJabatan", ":id") }}';
            url = url.replace(':id', id);
    ...
    //autofill nama detail_jabatan ADMIN
    $(document).ready(function () {
        $(document).on('change', '#nama_jabatan', function () {
            var id = $(this).val();
            var url = '{{ route("getDataNamaJabatan", ":id") }}';
            url = url.replace(':id', id);
